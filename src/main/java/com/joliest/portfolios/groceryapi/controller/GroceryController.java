...
public class GroceryController {
    ...
    @PutMapping("/item/{groceryItemId}")
    @ResponseStatus(HttpStatus.OK)
    public GroceryItem updateGroceryItemById(@PathVariable Integer groceryItemId,
                                      @RequestBody GroceryItemRequestModel requestBody
    ) {
        return groceryService.updateGroceryItemById(groceryItemId, requestBody);
    }
